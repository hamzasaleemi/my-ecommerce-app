                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mt-6 text-center">
                            ...
                            <p className="mt-6 text-lg leading-7">
                                ...
                                project for showcasing skills for job application. This application
                                includes cart functionality, products, low stock notification and cronjob for daily sales report.
                            </p>
                        </main>
